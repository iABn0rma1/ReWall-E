...
rps_w = [
    "Y-you, human, just beat a bot!",
    '"AI will run the world" they said... yet you defeated a program.',
    "I can't even hold a rock, a paper or scissors... That's not fair.",
    "I want to speak to your manager. I'm not allowed to lose.",
    'Yay, do you want a medal now?',
    'Okay you won, but this time only.',
    "You didn't even let me think of my move!"
]

rps_d = [
    "At least we're equally as good.",
    "There must be a mistake. ||Oh, it's you.||",
    "*Tududu, I be on my suit and TIE.* :necktie:",
    '"Draw", like my art teacher used to tell me, until she realized I was too bot for it.',
    "Honestly the game must be bugged at this point.",
    'Imagine playing a game where "no winner" is a possible outcome...'
]

rps_l = [
    "If I had hands, I'd be making an L shape with it on *YOUR* forehead.",
    "Imagine losing to a bot though. Isn't that cringe?",
    "Now bow to your Bot King!~刀れ么BOT best bot.",
    "See, you can't beat me now. Told you.",
    "It's okay, you'll wi- keep losing, actually.",
    "I was a RPS champion in my previous bot life. Guess I still am.",
    "There's only 3 outcomes... How can you lose to such a simple game?"
]